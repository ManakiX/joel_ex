...
const {sign, verify} = require('jsonwebtoken');//sign is based on email and password(think of at as, like, signing your signature)
// Creating a token
...
//
function verifyAToken(req, res, next) {//verifyAToken: checking if the user has the token.
    try{
